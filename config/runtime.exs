...
#
#     PHX_SERVER=true bin/credit_radar start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :credit_radar, CreditRadarWeb.Endpoint, server: true
end

config :credit_radar, :anbima_credentials,
...
if config_env() == :prod do
  ...
  #
  #     config :credit_radar, CreditRadar.Mailer,
